...
<img src="docs/images/projects-ru.png" alt="Проекты: все LoRA-проекты с текущим шагом, идущей тренировкой и очередью" width="100%">
...
У всех 182 параметров тренировки есть понятное описание и рекомендуемое значение на русском или английском: наведите на название настройки.
...
<tr>
<td width="50%" valign="top">
<img src="docs/images/overview-ru.png" alt="Обзор проекта" width="100%"><br>
<b>Обзор проекта</b> · Конвейер активной версии, ключевые цифры, задачи и версии на одной странице.
</td>
<td width="50%" valign="top">
<img src="docs/images/dataset-ru.png" alt="Датасет" width="100%"><br>
<b>Датасет</b> · Перетаскивание файлов или сбор с Booru, статистика по форматам и объёму.
</td>
</tr>
<tr>
<td width="50%" valign="top">
<img src="docs/images/curate-ru.png" alt="Отбор в train" width="100%"><br>
<b>Отбор в train</b> · Датасет → train-набор, папки концептов с повторами, validation-набор.
</td>
<td width="50%" valign="top">
<img src="docs/images/train-ru.png" alt="Тренировка" width="100%"><br>
<b>Тренировка</b> · Конфиг с подсказкой у каждой настройки, бюджет шагов и живой предпросмотр.
</td>
</tr>
<tr>
<td width="50%" valign="top">
<img src="docs/images/task-ru.png" alt="Задача" width="100%"><br>
<b>Задача</b> · Кривые loss и LR, сэмплы по эпохам, логи и выходные файлы.
</td>
<td width="50%" valign="top">
<img src="docs/images/queue-ru.png" alt="Очередь" width="100%"><br>
<b>Очередь</b> · Один слот GPU, план до конца очереди, пауза и продолжение.
</td>
</tr>
</table>
...
<img src="docs/images/task-ru.png" alt="Страница задачи: прогресс, loss и learning rate, сэмплы по эпохам" width="100%">
...
**🎨 Интерфейс**<br>
Новый дизайн, перенесённый постранично из утверждённого макета: тёплые нейтральные цвета, лаймовый акцент, шрифт Geist. У каждой настройки подсказка по наведению на название. Полностью на русском и английском, китайского в UI не осталось.
