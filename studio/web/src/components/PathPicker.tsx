...
export default function PathPicker({
  ...
  return (
    ...
    >
      <div
        className="bg-elevated border border-subtle rounded-2xl shadow-xl w-[640px] max-h-[80vh] m-modal flex flex-col overflow-hidden"
        ...
        <div className="flex-1 overflow-y-auto">
          {data?.entries.map((e) => {
            ...
            return (
              ...
              >
                <span className="text-fg-tertiary w-4 grid place-items-center shrink-0">
                  {e.type === 'dir' ? <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg> : <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden><path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z"/><path d="M14 3v5h5"/></svg>}
                </span>
