  ...
  return (
    <div className="relative" style={style} ref={ref}>
      ...
      {open && matches.length > 0 && (
        <ul
          className="absolute left-0 top-full mt-0.5 z-30 bg-elevated border border-subtle rounded-lg shadow-lg max-h-60 overflow-y-auto min-w-full list-none p-1 m-0"
          role="listbox"
        >
          {matches.map((s, i) => (
            <li
