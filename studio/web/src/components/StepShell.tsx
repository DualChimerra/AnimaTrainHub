...
export default function StepShell({ idx, title, subtitle, eyebrow, accentEyebrow = true, actions, topRight, children, belowHeader, logSources, mobilePageScroll }: Props) {
